...
public class ApFragment extends Fragment implements RecyclerAdapter.OnItemClickListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        backgroundTask.getList("AP", new BackgroundTask.VolleyResponseListener() {
            @Override
