...
public class BridgedFragment extends Fragment implements RecyclerAdapter.OnItemClickListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        backgroundTask.getList("Bridge", new BackgroundTask.VolleyResponseListener() {
            @Override
