...
public class Dot11DeviceLastProbedSsidRecord {

    @SerializedName("dot11.probedssid.wps_uuid_e")
    @Expose
    ...
    public void setDot11ProbedssidWpsUuidE(String dot11ProbedssidWpsUuidE) {
    ...
    public String getDot11ProbedssidSsid() {
        return dot11ProbedssidSsid;
    }

    public void setDot11ProbedssidSsid(String dot11ProbedssidSsid) {
    ...
    public String getDot11ProbedssidBssid() {
        return dot11ProbedssidBssid;
    }

    public void setDot11ProbedssidBssid(String dot11ProbedssidBssid) {
